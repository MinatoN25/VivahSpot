...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.apis(RequestHandlerSelectors.basePackage("com.stackroute.payment"))
				.paths(PathSelectors.regex("/api/v1/.*")).build().apiInfo(apiInfo());

	}

	private ApiInfo apiInfo() {
		ApiInfo apiInfo = new ApiInfo("Payment Microservice for VivahSpot",
				"payment microservice for vivahspot application", "VivahSpotApplication v1",
